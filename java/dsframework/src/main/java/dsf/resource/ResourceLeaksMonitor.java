...
class ResourceReference extends PhantomReference {
    ...
    private final static Logger logger = LogManager.getLogger(ResourceReference.class.getName());
    ...
    static {
        try {
            ...
            System.err.println("set referent accessible true failed");
            ex.printStackTrace();
        }
    }
...
public class ResourceLeaksMonitor extends MessageChildTask<ResourceLeaksMonitor.State> {
    ...
    //---------------------------------------------------------------------------
    private final static Logger logger = LogManager.getLogger(ResourceLeaksMonitor.class.getName());
...
class TestResource2 implements ITestResource {
