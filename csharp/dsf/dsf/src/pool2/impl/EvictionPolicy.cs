...
namespace org.apache.commons.pool2.impl
{
    ...
    public interface EvictionPolicy<T>
    {
        ...
        /// <param name="idleCount"> The current number of idle objects in the pool including
        ///                      the object under test </param>
        /// <returns> <code>true</code> if the object should be evicted, otherwise
